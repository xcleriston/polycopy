...
app.get('/api/user/me', (req, res) => {
    ...
    res.json(req.user ? {
        ...
        role: req.user.role,
        wallet: (_a = req.fullUser) === null || _a === void 0 ? void 0 : _a.wallet, // We'll enrich this in the middleware or fetch here
        config: (_b = req.fullUser) === null || _b === void 0 ? void 0 : _b.config
    } : { error: 'Not logged in' });
});
app.post('/api/user/generate-wallet', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    const user = yield User.findById((_a = req.user) === null || _a === void 0 ? void 0 : _a.id);
    if (!user)
        return res.status(404).json({ error: 'User not found' });
    if ((_b = user.wallet) === null || _b === void 0 ? void 0 : _b.address)
...
app.post('/api/user/update-config', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const user = yield User.findById((_a = req.user) === null || _a === void 0 ? void 0 : _a.id);
    if (!user)
        return res.status(404).json({ error: 'User not found' });
