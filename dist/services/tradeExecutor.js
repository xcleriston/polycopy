...
const doTrading = (trade) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const follower of followers) {
        ...
        try {
            ...
            yield Activity.updateOne({ _id: trade._id }, { $addToSet: { processedBy: follower.chatId } });
            ...
            if (PREVIEW_MODE) {
                ...
                yield postOrder(clobClient, trade.side === 'BUY' ? 'buy' : 'sell', my_position, user_position, trade, my_balance, follower.chatId, follower.config // Pass individual user config
                );
            }
        }
        catch (error) {
