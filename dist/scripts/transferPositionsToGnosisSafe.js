...
function transferPositions() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const positions = yield fetchData(`https://data-api.polymarket.com/positions?user=${EOA_ADDRESS}`);
        ...
        const eoaPositionsAfter = yield fetchData(`https://data-api.polymarket.com/positions?user=${EOA_ADDRESS}`);
        const gnosisPositionsAfter = yield fetchData(`https://data-api.polymarket.com/positions?user=${GNOSIS_SAFE_ADDRESS}`);
