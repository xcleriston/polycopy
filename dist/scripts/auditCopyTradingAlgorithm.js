...
function simulateTrader(traderAddress, startingCapital) {
    return __awaiter(this, void 0, void 0, function* () {
...
function simulateCombinedBot(traderResults) {
    return __awaiter(this, void 0, void 0, function* () {
...
function saveAuditReport(report) {
    ...
    const serializedResults = report.individualResults.map((r) => (Object.assign(Object.assign({}, r), { positions: Array.from(r.positions.entries()).map(([key, pos]) => (Object.assign({ key }, pos))) })));
    const data = Object.assign(Object.assign({}, report), { individualResults: serializedResults });
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            for (let i = 0; i < traderAddresses.length; i++) {
                ...
                const result = yield simulateTrader(trader, capitalPerTrader);
            ...
            const combinedResult = yield simulateCombinedBot(individualResults);
            // Calculate analysis
