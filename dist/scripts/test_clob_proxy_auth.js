...
function testClobWithProxy() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!u || !((_a = u.wallet) === null || _a === void 0 ? void 0 : _a.privateKey) || !((_b = u.wallet) === null || _b === void 0 ? void 0 : _b.clobCreds)) {
        ...
        const client = new ClobClient('https://clob.polymarket.com/', 137, wallet, creds, // PASS STORED CREDS
        SignatureType.POLY_GNOSIS_SAFE, proxy, proxy);
